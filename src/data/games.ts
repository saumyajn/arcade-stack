...
export const games: GameMeta[] = [
  ...
  },
  {
    id: 'context-climb',
    name: 'Context Climb',
    path: '/games/context-climb',
    image: coverArt['context-climb'],
    description: 'Guess the hidden word by using semantic closeness ranks and narrowing your way to #1.',
    tags: ['Semantic rank', 'Word vectors', 'Closeness'],
    engine: 'React bot',
    status: 'live',
  },
  {
